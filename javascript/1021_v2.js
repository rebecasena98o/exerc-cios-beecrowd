...
// Recebe o valor e multiplica por 100 para transformar em inteiro
let valor = parseFloat(lines[0]) * 100;

console.log("NOTAS:");

// Os valores de notas daqui para frente vao estar multiplicados todos por 100, tanto para compensar 
//que o valor inicial foi por 100 tanto para que com as moedas fique inteiro.

// Declara o valor da Nota(No caso 100 x 100 = 10000)
let valorNota = 10000;

// O resto da divisao é o que não é multiplo do valorNota, logo o que no "valor" não pode ser agrupado em valorNota
